  ...
  <div class="relative bg-white">
    <div class="lg:absolute lg:inset-0">
      <div class="lg:absolute lg:inset-y-0 lg:left-0 lg:w-1/2">
        <img class="object-cover w-full h-56 lg:absolute lg:h-full" src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?ixlib=rb-1.2.1&auto=format&fit=crop&w=1567&q=80" alt="" />
      </div>
    </div>
    <div class="relative px-4 pt-12 pb-16 sm:pt-16 sm:px-6 lg:px-8 lg:max-w-7xl lg:mx-auto lg:grid lg:grid-cols-2">
      <div class="lg:col-start-2 lg:pl-8">
        <div class="mx-auto text-base max-w-prose lg:max-w-lg lg:ml-auto lg:mr-0">
          <h2 class="font-semibold leading-6 tracking-wide uppercase text-emerald-600">На курсе вы получите следующие навыки:
</h2>
          <h3 class="mt-2 text-3xl font-extrabold leading-8 tracking-tight text-gray-900 sm:text-4xl">Разработка автотестов</h3>
          <p class="mt-8 text-lg text-gray-500">Научитесь создавать скрипты, которые имитируют поведение человека для автоматической проверки работы продукта.</p>
          <div class="mt-5 prose text-gray-500 prose-emerald">
